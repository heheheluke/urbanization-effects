    ...
    function showInfo(d,str) {
      ...
      hoverDot.append("div")    //Govt exp
        ...
        .text(function() {if (d["Govt exp (Exp)"] != '') {
          return "Govt exp (Exp)" + ": " + Math.round((d["Govt exp (Exp)"]) * 100) / 100 + "%";
        }
        else {
          return "Govt exp (Exp): N/A";
        }
        })
      ...
      hoverDot.append("div")  //Educ attainment
        ...
        .text(function() {if (d["Edu attainment (primary)"] != '') {
          return "Educ. attainment (primary)" + ": " + Math.round((d["Edu attainment (primary)"]) * 100) / 100 + "%";
        }
        else {
          return "Educ. attainment (primary): N/A";
        }
        })
